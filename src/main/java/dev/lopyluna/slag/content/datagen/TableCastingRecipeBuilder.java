...
public class TableCastingRecipeBuilder implements RecipeBuilder {
    ...
    private TableCastingRecipeBuilder(ItemStack result, FluidStack input, TagKey<Item> castType) {
    ...
    public void save(RecipeOutput recipeOutput, ResourceLocation loc) {
        ...
        TableCastingRecipe recipe = this.factory.create(Objects.requireNonNullElse(this.group, ""), this.castType, this.input, this.stackResult);
